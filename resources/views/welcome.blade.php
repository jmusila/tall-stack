<x-guest-layout>
   <div class="flex flex-col bg-indigo-900 w-full h-screen" x-data="{showSubscribe: false,}">
    ...
    <div class="flex fixed top-0 bg-gray-900 bg-opacity-60 items-center justify-center w-full h-full" x-show="showSubscribe" x-on:click.self="showSubscribe = false">
